 ...
 * other stdout error (e.g. EBADF with stdout closed) prints one
 * `Output error: <message>` line to stderr and exits 1; any other stderr error
 * exits 1 silently (there is nowhere left to report it). The bin shim installs
